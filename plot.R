...
plotbars<- function(data1, data2, data3, 
  ...
  plot(df$x, df$y, type = "l", col = hues[1],  ylim=c(minn, maxx), #ylim = c(0.96, 0.985),   #choose ylim CAREFULLY as per your data ranges
       main = "Best Fitness Values after Mutation", xlab = "Generations", ylab = "Fitness")  #plot the line (mean values)
...
plotbars(parsed_data1, parsed_data2, parsed_data3, cap1 = "Pop Size 15", cap2 = "Pop Size 30", cap3 = "Pop Size 50")